...
function App() {
  ...
  /* mode : 지금 현재 상태의 모드 지정 */
	...
	const categoryList = [{key:'bread', value:'빵'}, {key:'beverage', value:'음료수'}, {key:'cake', value:'케이크'}];
	...
	/* 컬럼별 정렬 기능 */
	/* 기본 값으로 상품 이름에 대하여 오름차순으로 정렬 하겠습니다. */
	...
	return(
		<Card>
			...
			<Card.Body>
				<Content contents={products} onClickToContent={ClickArrived} onOrderByClick={ClickOrderBy} orderInfo={orderInfo} />
			</Card.Body>			
			<Card.Body>
				{getContent()}
			</Card.Body>
